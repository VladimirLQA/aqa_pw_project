...
export const updateValueInObject = (obj: any, keyToFind: string, newValue: Function) => {
...
export const hideValueInObject = (obj: object, keyToFind: string) => updateValueInObject(obj, keyToFind, hideSecretData);
